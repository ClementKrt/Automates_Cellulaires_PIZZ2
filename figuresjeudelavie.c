...
void petitefloraison(int ** mat,int n){
  ...
  //Initialisation manuelle de l'état de base d'une petite floraison
  mat[n/2 -1][n - 1] = 1;
  mat[n/2 - 1][n] = 1;
  mat[n/2 - 1][n + 1] = 1;
  mat[n/2][n - 2] = 1;
...
void petitsoscillateurs(int ** mat,int n){
  if(n < 10)
   ...
   //Initialisation manuelle de 3 petits oscillateur, 2 dans les coins supèrieurs et 1 au milieu
   mat[1][1] = 1;
   mat[2][1] = 1;
   mat[3][1] = 1;
